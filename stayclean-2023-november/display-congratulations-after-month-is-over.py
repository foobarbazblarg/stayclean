...
def templateToUse():
    return f'''CONGRATULATIONS TO THE VICTORS OF THE STAY CLEAN UPPERCASE_MONTH CHALLENGE!
Hey everybody, take a second to post a congratulatory comment to the victors of the Stay Clean CURRENT_MONTH_NAME challenge, listed below. **NUMBER_STILL_IN** out of INITIAL_NUMBER original participants made it. that's **PERCENT_STILL_IN%**. Victors, feel free to post a comment with your thoughts about the month. Was there anything specific that worked to keep you clean? What advice do you have for the rest of us? Here are our **NUMBER_STILL_IN victors**:
