...
# Edit me!
challengePageSubmissionId = editme.challengePageSubmissionId
flaskport = editme.challengePageFlaskPort
readAllCommentsWhichCanBeSlower = editme.readAllCommentsWhichCanBeSlower
...
# Need to type check the submission.  What is the class?
...
# Need to type check the comments.  What is the class?
def getCommentsForSubmission(submission) -> List[praw.models.Comment]:
...
def moderatechallenge() -> Response:
...
def copydisplaytoclipboard() -> Response:
    actionToTake = request.form["actiontotake"]
