...
# nextMonthURL = "(October 2020 url goes here)"
...
def templateToUse():
    return f'''The Stay Clean CURRENT_MONTH_NAME challenge is now over.  Join us for **[the NEXT_MONTH_NAME challenge](NEXT_MONTH_URL)**.
...
def stringToPrint():
    ...
    answer = re.sub('NEXT_MONTH_URL', editme.nextMonthURL, answer)
    return answer
