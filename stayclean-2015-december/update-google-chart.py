...
# Google spreadsheet stuff, now with oauth2 authentication.
# - Following instructions here: *http://gspread.readthedocs.org/en/latest/oauth2.html*
# - created new service account called update-google-chart
# -- The keyid on the Google Developer Console is 9a9cd365892a0c75957e42939f7e77fd7c658e07, date is 2015.12.18
# -- copied the resulting json file to ~/stayclean/google-oauth-credentials.json
# --- We put that file into .gitignore, so as to not share with the world.
# -- For any spreadsheet that we want scripts to act upon, we need to share them with the client email in the json file.
