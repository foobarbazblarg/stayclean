...
# EDIT ME!
# Remember, this is during signup, so current month is not December, it's November.
currentMonthTotalDays = 30
currentMonthURL = "https://www.reddit.com/r/pornfree/comments/3r2msp/stay_clean_november_this_thread_updated_daily/"
