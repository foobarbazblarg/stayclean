...
activeCommentHashFiles = [ 'retiredcommenthashes.txt',
                           ...
                           '../stayclean-2017-february/retiredcommenthashes.txt',
                           '../stayclean-2017-march/retiredcommenthashes.txt',
                           '../stayclean-2017-april/retiredcommenthashes.txt',
                           '../stayclean-2017-may/retiredcommenthashes.txt',
                           '../stayclean-2017-june/retiredcommenthashes.txt',
                           '../stayclean-2017-july/retiredcommenthashes.txt',
