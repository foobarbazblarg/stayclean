...
# Edit Me!
# Remember, this is during signup, so current month is not August, it's July.
currentMonthTotalDays = editme.previousMonthTotalDays
currentMonthURL = editme.previousMonthURL
...
def templateForFirstSignupDay():
    return f'''STAY CLEAN UPPERCASE_MONTH!  Sign up here!  (CURRENT_MONTH_NAME CURRENT_DAY_OF_MONTH_INDEX)
Hey everybody, we had a great turnout for [Stay Clean CURRENT_MONTH_NAME](CURRENT_MONTH_URL) - let's see if we can knock it out of the park for NEXT_MONTH_NAME.  Have you been clean for the month of CURRENT_MONTH_NAME?  Great!  Join us here, and let's keep our streak going.  Did you slip in CURRENT_MONTH_NAME?  Then NEXT_MONTH_NAME is your month to shine, and we will gladly fight the good fight along with you.  Did you miss out on the CURRENT_MONTH_NAME challenge?  Well then here is your opportunity to join us.

If you would like to be included in this challenge, please post a brief comment to this thread, and I will include you.  After midnight, NEXT_MONTH_NAME 1, the sign up window will close, and the challenge will begin.'''


def templateForMiddleSignupDays():
    return f'''STAY CLEAN UPPERCASE_MONTH!  Sign up here!  (CURRENT_MONTH_NAME CURRENT_DAY_OF_MONTH_INDEX)
Hey everybody, so far **INITIAL_NUMBER participants** have signed up.  Have you been clean for **[the month of CURRENT_MONTH_NAME](CURRENT_MONTH_URL)**?  Great!  Join us here, and let's keep our streak going.  Did you slip in CURRENT_MONTH_NAME?  Then NEXT_MONTH_NAME is your month to shine, and we will gladly fight the good fight along with you.  Did you miss out on the CURRENT_MONTH_NAME challenge?  Well then here is your opportunity to join us.
